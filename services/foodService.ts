...
const MOCK_FOOD_ITEMS: FoodItem[] = [
  {
    id: '1',
    name: 'Classic Burger',
    description: 'Beef patty, cheddar, lettuce, tomato, house sauce on brioche.',
    price: 89,
  ...
  },
  {
    ...
    price: 99,
    image: 'https://images.unsplash.com/photo-1626082927389-6cd097cfd83e?w=800&h=600&fit=crop',
    category: 'chicken',
    rating: 4.6,
    reviews: 198,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    price: 29,
    image: 'https://images.unsplash.com/photo-1599599810694-f3f465b6ee0d?w=800&h=600&fit=crop',
    category: 'drinks',
    rating: 4.4,
    reviews: 88,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    price: 119,
    image: 'https://images.unsplash.com/photo-1571115764595-644a12c7cb72?w=800&h=600&fit=crop',
    category: 'burgers',
    rating: 4.6,
    reviews: 210,
    createdAt: Date.now(),
...
export const getFoodItems = async (): Promise<FoodItem[]> => {
  try {
    ...
    console.error('getFoodItems: Error fetching items, falling back to mock data:', error);
